...
<section id="somos" class="somos">
    <div class="stage conteudoSomos">
      ...
      <p>Acreditamos na singularidade de cada cliente, reconhecendo suas histórias, necessidades e desafios únicos.
        ...
        <br>Com mais de <b>17 anos de experiência em logística</b>, gestão de riscos e seguros, não adotamos abordagens genéricas. Em vez disso, nos dedicamos a oferecer soluções alinhadas e especializadas para cada parceiro.
...
<section class="secTestimonial">
  <div class="stage testimonial-carousel">
      <div class="testimonial">
        ...
        <h4 class="nomeCliente">Ana Paula Caris <br> Coordenadora de Importação</h4>
      ...
      <div class="testimonial">
        ...
        <h4 class="nomeCliente">Everton Nunes – CFO</h4>
      ...
      <div class="testimonial">
        ...
        <h4 class="nomeCliente">Fernando Raicoski - Gerente de Comex</h4>
      ...
      <div class="testimonial">
        ...
        <h4 class="nomeCliente">Fernanda Bellucco Ferreira - Gerente de Vendas</h4>
